...
// Paths (match your crons + tropical_data.php)
$BASE_DIR     = __DIR__;
$CACHE_FILE   = $BASE_DIR . '/cache/nhc_current_storms.json';
$SUMMARY_FILE = $BASE_DIR . '/cache/tropical_summary_at.json';
