// =======================
// San Diego County Radar Module - radar.js
// Local temporary radar implementation for the San Diego workflow.
// ========================
...
class RadarModule {
    constructor() {
        ...
        this.regionalStation = 'PACSOUTHWEST';
    }
    ...
    updateProductOptions() {
        ...
        const products = station === this.regionalStation ? this.regionalProducts : this.localProducts;
    ...
    buildRadarUrl() {
        ...
        if (station === this.regionalStation) {
            return `${baseUrl}PACSOUTHWEST_${suffix}.gif`;
        }
