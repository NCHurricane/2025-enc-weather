...
// Replace the existing renderForecast function with this version
...
async function renderForecast(){
  try{
    ...
    // Show ALL periods (removed slice limit)
...
async function renderDetailedForecast(){
  try{
    ...
    // Show first 6 periods for readability in detailed view
...
//     // TEMPORARY: Add fake alert for testing
//     if (list.length === 0) {
//       list = [{
//         headline: "Coastal Flood Advisory",
//         event: "Coastal Flood Advisory", 
//         description: "Minor coastal flooding expected. Water levels 1 to 2 feet above ground level in low lying areas near shorelines and tidal waterways.",
//         severity: "Minor"
//       }];
//     }
...
//     const alertsHTML = list.map((alert, index) => {
//       const eventName = alert.headline || alert.event || alert.type || "Alert";
//       const description = alert.description || alert.summary || "";
