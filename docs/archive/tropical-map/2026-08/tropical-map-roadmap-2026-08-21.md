...
> Archived historical roadmap preserved on 2026-08-22. Its Phase 4 target,
> source inventory, runtime assumptions, and continuation prompt reflect the
> earlier checkpoint and are not current operational guidance. Use the
> [current tropical handoff](../../../tropical-map-next-session-plan.md).
