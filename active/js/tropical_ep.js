// =============================
// Eastern Pacific Tropical Data Handler - active/js/tropical_ep.js
//
// Constructs and renders the Eastern Pacific tropical text products on the Eastern Pacific storm page
// ==============================
...
const PATHS = {
    two_en: `${BASE}/twoep.json`,
    disc: `${BASE}/twdep.json`,
    summary: `${BASE}/twsep.json`,
};
...
function updateSatelliteActionButton(sector) {
    ...
    const sectorUrls = {
        tpw: 'https://www.star.nesdis.noaa.gov/GOES/sector.php?sat=G18&sector=tpw',
        np: 'https://www.star.nesdis.noaa.gov/GOES/sector.php?sat=G18&sector=np',
        wus: 'https://www.star.nesdis.noaa.gov/GOES/sector.php?sat=G18&sector=wus',
        mex: 'https://www.star.nesdis.noaa.gov/GOES/sector.php?sat=G19&sector=mex',
        hi: 'https://www.star.nesdis.noaa.gov/GOES/sector.php?sat=G18&sector=hi',
    };
...
async function init() {
    const { initSatellite } = await import(`../js/satellite_ep.js?t=${Date.now()}`);
    const [twoEn, disc, summary] = await Promise.all([
    ...
    updateSatelliteActionButton('tpw');
