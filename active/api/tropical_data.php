...
$config = [
    ...
    'cache_file'  => dirname(__DIR__, 2) . '/active/cache/nhc_current_storms.json',
    'summary_file'=> dirname(__DIR__, 2) . '/active/cache/tropical_summary_at.json',

    'cache_ttl'   => 1800,

    'user_agent'  => 'NCHurricane.com Weather App/1.0 (Tropical Data Handler)',
    'log_file'    => dirname(__DIR__, 2) . '/active/logs/tropical_data.log'
];
